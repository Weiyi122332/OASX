...
final Map<String, String> _us_ui = {
  ...
  I18n.argsTaskListEmpty: 'No tasks yet, use Add task to add one',
  I18n.argsTaskListAdd: 'Add task',
  I18n.argsTaskListRemove: 'Remove from the group',
  I18n.argsTaskListReorder: 'Drag the handle to change the order',
  I18n.argsTaskListLimit: 'Max tasks',
